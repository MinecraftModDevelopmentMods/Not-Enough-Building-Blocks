...
class TileSimpleSlope : BaseTile() {
    ...
    companion object {
        ...
        private fun getModel(textureMap: Map<String, IBlockState>, tile: TileSimpleSlope? = null): BlockInfo {
            ...
            val orientation = tile?.world?.getBlockState(tile.pos)?.getValue(BaseOrientedBlock.FACING) ?: EnumFacing.NORTH
            ...
            builder.setCacheKeyTransformer { "${orientation.name}$it" }
